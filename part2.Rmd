...
To discover this, we construct 95% confidence intervals using t-tests, comparing the means of length for each dose (ignoring the supplement).
...
To discover this, we construct 95% confidence intervals using t-tests, comparing the means of length for each dose between supplements.  
